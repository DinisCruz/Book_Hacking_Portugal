...
The tech world is trying to find ways to connect data sets in a way that makes _'reality understandable/visible'_, so that what is really going on, is exposed in a way that is both easy to consume, and actionable.
...
It would be great if the current debate was on what is _..... (to be defined)_ , ideally with several active experiments going on to figure out the best metrics, but we are still a long way from that stage of development
